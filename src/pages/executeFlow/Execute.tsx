...
const ExecuteFlow: React.FC<ExecuteProp> = ({
  ...
  const [executionResultModalIsOpen, setExecutionResultModalIsOpen] = useState(false)
  ...
  return (
    <div>
      ...
      <Modal isOpen={executionResultModalIsOpen} onRequestClose={() => setExecutionResultModalIsOpen(false)} title="Graph execution result">
        <ExecutionResult executionResult={executionResult}/>
      </Modal>

      <Modal isOpen={exectionLogModalIsOpen} onRequestClose={() => setExectionLogModalIsOpen(false)} title="Graph execution log">
